INSERT INTO Songs (SongId, Title) VALUES
('1', 'Overture'),
...
INSERT INTO Band (Id, Firstname, Lastname) VALUES
('1', 'Solveig', 'Heilo'),
('2', 'Marianne', 'Sveen'),
('3', 'Anne-Marit', 'Bergheim'),
('4', 'Turid', 'Jorgensen');

INSERT INTO Albums (AId, Title, Year, Label, Type) VALUES
...
INSERT INTO Vocals (SongId, Bandmate, Type) VALUES
('2', '1', 'lead'),
('2', '3', 'chorus'),
('2', '4', 'chorus'),
('3', '2', 'lead'),
...
INSERT INTO Tracklists (AlbumId, Position, SongId) VALUES
('1', '1', '1'),
('1', '2', '2'),
('1', '3', '3'),
('1', '4', '4'),
